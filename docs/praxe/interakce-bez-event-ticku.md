...
**Souvislosti:** [Overlap trigger](#overlap-trigger-misto-trasovani-v-ticku) výše · [Komunikace Blueprintů](komunikace-blueprintu.md) · [Optimalizace: co blokuje hlavní vlákno](optimalizace.md#druha-osa-optimalizace-co-blokuje-hlavni-vlakno) *(příbuzný lék o patro níž)* · [Komunikace Blueprintů: kolik stojí cast](komunikace-blueprintu.md#interface-nebo-dispatcher-a-kolik-doopravdy-stoji-cast) *(změřená cena tvrdé reference)* · [Rejstřík: Blueprint Interface](../rejstrik.md#blueprint-interface) · [Rejstřík: cast](../rejstrik.md#cast) · [Rejstřík: garbage collection](../rejstrik.md#garbage-collection)
