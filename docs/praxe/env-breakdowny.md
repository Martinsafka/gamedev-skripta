...
## Naughty Dog: shadery místo polygonů a nástroj místo modelování

**Zdroj:** [How Naughty Dog Automates AAA Art (TLOU Part 1)](https://www.youtube.com/watch?v=dqfvgA7oKC4) · [Next Level Game Art](https://www.youtube.com/channel/UCmPBLkozH1irLObN0Q3_aJw) · ~12 min, breakdown

**Shrnutí:** Rozbor pipeline dvou artistů Naughty Dog otevírá tezí, která jde proti intuici [(0:02)](https://www.youtube.com/watch?v=dqfvgA7oKC4&t=2s): *„většina studentů si myslí, že tajemství TLOU Part 1 jsou obrovské poly county a velký tým dřící na detailech. Ve skutečnosti je to přesný opak — topologie assetů je docela konzervativní."* Váha produkce se přesunula **z geometrie do vrstvených shaderů** a z ručního modelování **do procedurálního nástroje**.

### Rozpad myšlenky

**Hustota geometrie slouží blendování, ne siluetě** [(3:09)](https://www.youtube.com/watch?v=dqfvgA7oKC4&t=189s) — a tohle je ta nejpřenositelnější věc z celého videa. Polygony jsou rozprostřené **rovnoměrně**, ne nahuštěné tam, kde je detail: *„meshe jsou rozdělené tak, aby topologie umožnila malovat vertex barvy a plynule blendovat vícevrstvé shadery bez náhlých přechodů nebo protažených blendů mezi vrcholy, které jsou příliš daleko od sebe."* Jinými slovy: **když detail dělá shader, geometrie existuje kvůli tomu, aby ten shader měl kam přejít.** Praktický vedlejší produkt jejich in-game wireframe zobrazení [(2:22)](https://www.youtube.com/watch?v=dqfvgA7oKC4&t=142s): **tloušťka hran označuje hustotu polygonů**, takže je to zároveň debug pohled.

**Roughness jako podceněná polovina realismu** [(3:09)](https://www.youtube.com/watch?v=dqfvgA7oKC4&t=189s): z rozpadu BRDF passů autor tráví nejvíc času **barvou a roughness** — *„roughness je velmi důležitá součást realisticky vypadajících materiálů a vyžaduje mnohem víc práce, než si většina studentů uvědomuje."* V závěru to zopakuje jako kariérní radu: *„zapracuj na roughness mapách. Nemůžu to dost zdůraznit — většina absolventů to úplně přeskočí."*

**Ledový shader jako případovka falešné hloubky** [(3:56)](https://www.youtube.com/watch?v=dqfvgA7oKC4&t=236s) je nejlepší technický kus. Cíl: *„iluze skutečné tloušťky a hloubky ledu, s kamenným dnem řeky rozostřeným, ale pořád viditelným metr pod povrchem."* Řešení stojí na **několika parallax occlusion efektech** pro různé tloušťky prasklin — a k tomu poznámka, která ukazuje, jak se v produkci uvažuje o ceně [(4:44)](https://www.youtube.com/watch?v=dqfvgA7oKC4&t=284s): **„rozlámanost prasklin dovolila vystačit s minimem vrstev v parallax funkci, což snížilo cenu renderu."** Nepravidelnost motivu je tedy zároveň výtvarné rozhodnutí i optimalizace. Jemné praskliny a nerovnosti pak řeší **normal mapa s velmi nízkou intenzitou**, roughness zůstává nízká s mírnou variací kvůli odrazům.

Vrstvení samo [(5:30)](https://www.youtube.com/watch?v=dqfvgA7oKC4&t=330s) je poučné svou repetitivností: průhlednost s lomem (height mapa v roli průhlednosti) → parallax praskliny → definice linií jen z diffuse → povrchový detail z roughness a normal → zesvětlení → **falešná hloubka přes velkoplošné AO použité jako násobení** → maskování části prasklin, *„aby se rozbila opakovanost"*. K tomu ruční práce mimo engine: velkoplošné overlaye z Photoshopu, které **přerušují některé linie prasklin**, aby led působil proměnlivě silný.

**Houdini nástroj místo modelování** [(7:03)](https://www.youtube.com/watch?v=dqfvgA7oKC4&t=423s): protože je hra plná rozbořených cihlových zdí, vznikl procedurální nástroj (autoři mu říkají „brick wall destroyer 3000") s automatickým vkládáním cihel, jejich škálováním a rozmístěním, **primárními, sekundárními a terciárními boolean detaily**, spárovými booleany a **hloubkou eroze** — ovládaný z Mayi přes plugin. Odhad přínosu: *„pravděpodobně to zkrátilo produkční čas environment týmu o týdny nebo měsíce."*

A hned poctivá výhrada, díky které je to použitelná rada a ne obdiv [(8:24)](https://www.youtube.com/watch?v=dqfvgA7oKC4&t=504s): *„postavit takový nástroj a rozchodit pluginy mezi Houdini, Mayou a enginem nějaký čas v preprodukci zabere — ale jakmile je to v pipeline a připravené pro všechny, u projektu zasazeného do postapokalyptického světa, kde jsou rozbité cihlové zdi všude, je to nutnost."* **Podmínka návratnosti je opakování**, ne velikost studia.

> **Pozn.:** Závěrečná rada míří na portfolio, ale platí i pro sólo projekt [(10:47)](https://www.youtube.com/watch?v=dqfvgA7oKC4&t=647s): **„nestav jen assety, stav pipeline"** — modulární komponenty, které jdou sdílet, znovu použít a rychle iterovat. Pro nás to je táž myšlenka jako [master material](materialy.md#master-material-pet-textur-nema-mit-kazdy-mesh) v malém: jednorázová investice, která se vrací s každým dalším assetem. Video je zároveň propagací autorova placeného kurzu a partnerských balíčků tutoriálů; obsahu breakdownu to neubírá, ale patří to k obrázku.

**Souvislosti:** [TLOU: trim sheet](#tlou-trim-sheet-ktery-nahradil-tisice-bake) *(tatáž hra, jiná část pipeline)* · [Crimson Desert: detektivka kolem displacementu](#crimson-desert-detektivka-kolem-displacementu) *(parallax jako iluze hloubky podruhé)* · [Materiály: master material](materialy.md#master-material-pet-textur-nema-mit-kazdy-mesh) · [Herní art: prostředí je 90 % obrazovky](../teorie/art-pipeline.md#prostredi-je-90-obrazovky-a-musi-mluvit) · [Rejstřík: BRDF](../rejstrik.md#brdf) · [Rejstřík: parallax occlusion mapping](../rejstrik.md#parallax-occlusion-mapping)
