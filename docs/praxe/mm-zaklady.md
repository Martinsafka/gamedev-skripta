...
**Souvislosti:** [Scope: malé hry](../teorie/scope.md) · [Zápisky: dokumentace jako audit](../zapisky/dokumentace-jako-audit.md) *(sparse sázka z produkce vlastní MM komponenty)* · [Rejstřík: sparse set](../rejstrik.md#sparse-set) · [Rejstřík: root motion](../rejstrik.md#root-motion)
