...
**Souvislosti:** [Scope: malé hry](../teorie/scope.md) · [Zápisky: dokumentace jako audit](../zapisky/dokumentace-jako-audit.md) *(sparse sázka z produkce vlastní MM komponenty)* · [Zápisky: pravidlo 70/30](../zapisky/pravidlo-70-30.md) *(dělba čistý MM vs. procedurální tlumič v téže komponentě)* · [Rejstřík: sparse set](../rejstrik.md#sparse-set) · [Rejstřík: root motion](../rejstrik.md#root-motion)
...
**Souvislosti:** [Systémy nad Motion Matchingem](mm-systemy.md) · [AI assety: animace v reálném čase](ai-assety.md#animace-generovana-v-realnem-case-kam-se-posunulo-ardy) *(tatáž úloha modelem místo databáze)* · [Rejstřík: blend stack](../rejstrik.md#blend-stack) · [Rejstřík: stitching](../rejstrik.md#stitching) · [Rejstřík: continuing pose](../rejstrik.md#continuing-pose)
