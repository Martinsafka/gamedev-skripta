...
**Souvislosti:** [Principy architektury: tři principy](principy-architektury.md#tri-principy-skalovatelnosti-separace-volne-vazby-data) · [Komunikace: broadcast kanály](komunikace-blueprintu.md#ctvrty-kanal-broadcast-pres-subsystem-s-payloady) · [Rejstřík: gameplay tag](../rejstrik.md#gameplay-tag) · [Rejstřík: Blueprint Function Library](../rejstrik.md#blueprint-function-library)
