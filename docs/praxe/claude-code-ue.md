...
## Proč nativní MCP samo nestačí — a co s tím

**Zdroj:** [Claude And New UE 5.8 MCP is Crazy Good (But I made it better)](https://www.youtube.com/watch?v=I5WLl4MdK28) · [Stefan 3D AI](https://www.youtube.com/channel/UCRW08KcTVjXEmBzBsVl7XjA) · ~17 min, test a workflow

**Shrnutí:** Nejcennější věc na tomhle videu je korekce očekávání, kterou nikdo jiný neřekne nahlas [(0:00)](https://www.youtube.com/watch?v=I5WLl4MdK28&t=0s): *„Native MCP samo o sobě všechnu tu magii neudělá. Demo, které jste viděli na prezentaci Unrealu, bylo pečlivě připravené. Když si nainstalujete agenta a aktivujete MCP, nejspíš se ničemu takovému ani nepřiblížíte."* A hned dodatek, který z toho nedělá hejt: *„pořád je to skvělé, jen kolem toho potřebujete správný setup."* Zbytek videa je popis toho setupu — a **funkční metody, která nestaví scénu, ale PCG graf.**

### Rozpad myšlenky

**Co konkrétně na demu bylo připravené** [(7:42)](https://www.youtube.com/watch?v=I5WLl4MdK28&t=462s): *„PCG grafy, modely a assety byly pečlivě připravené. Všechny budovy jsou modulární a spousta assetů tam už byla. A bylo tam připravených hodně PCG grafů, aby vám mohli ukázat tyhle super věci."* Agent tedy na demu **neuměl něco navíc — měl k dispozici víc.** To je rozdíl, který stojí za zapamatování u každé prezentace AI nástroje.

**Limity nativního MCP** jsou vyjmenované konkrétně [(1:32)](https://www.youtube.com/watch?v=I5WLl4MdK28&t=92s): **neumí spouštět Python skripty**, má omezené jemné doladění materiálů a objektů, a **importuje jen FBX nebo OBJ** — *„když chci naimportovat AI generovaný GLB, řekne mi, ať si asset naimportuju sám"*. Poslední bod je pro pipeline s generovanými assety zabiják, protože přesně ten formát z generátorů leze.

**Poctivé přiznání neúspěchu** [(3:05)](https://www.youtube.com/watch?v=I5WLl4MdK28&t=185s): autor vygeneroval zhruba šedesát optimalizovaných assetů, dal agentovi referenční obrázek a nechal ho hodinu stavět město. Výsledek okomentoval bez příkras — *„tohle je blbost. Tak jsem začal zkoumat, co tomu chybí, aby ten setup fungoval."* Řešením je **komunitní plugin vedle nativního MCP**, který ho rozšiřuje; instalace znamená naklonovat repozitář (klidně to nechat udělat agenta), **ručně zapnout oba pluginy** (nejsou zapnuté defaultně), restartovat editor, zapnout **Auto Start Server** a vygenerovat `.mcp.json` [(4:37)](https://www.youtube.com/watch?v=I5WLl4MdK28&t=277s). Mimochodem tam padne i rada, která nesouvisí s AI, ale je správná: *„git je zásadní — pokud jste začátečník, slouží ke sledování verzí projektu, abyste se vždycky mohli vrátit, když se něco pokazí."*

**A teď ta metoda, kvůli které se video vyplatí** [(8:28)](https://www.youtube.com/watch?v=I5WLl4MdK28&t=508s). Místo „postav mi město" jde autor po promptech a **všechno staví jako PCG**: prázdný landscape s trávou → **řeka jako spline** → **cesta jako spline** → budovy podél cest → screenshot a prompt „oprav, ať domy nestojí na řece" → **most** → logika křižovatek → tráva → stromy. Klíčová věta [(13:05)](https://www.youtube.com/watch?v=I5WLl4MdK28&t=785s): *„nechtěl jsem ukázat další vyšperkovaný příklad něčeho úplně zbytečného. Tohle je mnohem lepší, protože ti to pomůže vytvořit něco, co můžeš ovládat."* Upravíš splajn a všechno se přepočítá — **výsledkem práce agenta není scéna, ale nástroj na scény.**

Detail, který ukazuje, že to autor opravdu dělal [(10:46)](https://www.youtube.com/watch?v=I5WLl4MdK28&t=646s): most nešlo vyřešit vygenerováním mostu. *„Když vygeneruješ celý most a řekneš mu, ať ho někam umístí, nebude to fungovat — je to procedurální generování a most může být různě dlouhý a široký. Tak jsem vygeneroval krátkou dlaždici mostu, aby se dala použít procedurálně."* **Modularita není estetická preference, je to podmínka toho, aby procedura měla s čím pracovat.**

**Kde agent naráží** [(9:14)](https://www.youtube.com/watch?v=I5WLl4MdK28&t=554s): textura vyšla protažená, protože *„má špatné vidění"* — autor srovnává jednotlivé modely a tvrdí, že u úkolů založených na prohlédnutí screenshotu jsou na tom některé znatelně líp než jiné (jeho dobové srovnání, ne ověřený fakt). Zásadní limit shrne jednou větou [(12:19)](https://www.youtube.com/watch?v=I5WLl4MdK28&t=739s): **„nedokáže se podívat a udělat něco hezkého nebo dokonce zreplikovat obrázek."** A druhá výhrada je čistě řemeslná [(14:38)](https://www.youtube.com/watch?v=I5WLl4MdK28&t=878s): *„blueprint grafy vypadají hrozně — všechny uzly naskládané na jednom místě a nějak pospojované. To je reálný problém, budete si je muset uspořádat sami."*

> **Pozn.:** Dva praktické údaje na závěr. **Kolik to stojí času** [(16:10)](https://www.youtube.com/watch?v=I5WLl4MdK28&t=970s): *„celý proces v tomhle videu zabere kolem dvou hodin, protože každý prompt je pět až deset minut — podle toho, kolik toho o Unrealu víte. Když se ptáte na správné věci, projdete tím rychleji."* Což je tatáž podmínka jako v [prvním MCP entry](#nativni-mcp-v-58-setup-a-prvni-testy): **agent zkracuje práci naučených.** A **dosah mimo engine** [(13:52)](https://www.youtube.com/watch?v=I5WLl4MdK28&t=832s): agent umí přes API sáhnout na generátor textur i na Blender — *„úspěšně vygeneroval stébla trávy v Blenderu, vyexportoval je jako GLB a naimportoval do Unrealu"* — což je [lokální pipeline](#agent-v-blenderu-a-comfyui-lokalni-pipeline) z jiné myšlenky téhle kapitoly, jen řízená odjinud. Video obsahuje affiliate odkaz na 3D generátor a autorovy vlastní konfigurační soubory ke stažení.

**Souvislosti:** [Nativní MCP v 5.8: setup a první testy](#nativni-mcp-v-58-setup-a-prvni-testy) *(co video koriguje)* · [Agent v Blenderu a ComfyUI](#agent-v-blenderu-a-comfyui-lokalni-pipeline) · [72 hodin: dělba práce člověk–AI](#72-hodin-delba-prace-clovekai) · [PCG základy](pcg-zaklady.md) *(co agent vlastně staví)* · [Organizace projektu: Git v Unrealu](organizace-projektu.md#git-v-unrealu-verzovani-z-editoru-a-cesta-zpet-v-case) · [Rejstřík: MCP](../rejstrik.md#mcp) · [Rejstřík: PCG](../rejstrik.md#pcg)
