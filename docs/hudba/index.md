...
Hudba a zvuk rozhodují o tom, jestli hra *žije* — a přitom je samouci často odkládají na konec. Tahle sekce je studijní materiál k tomu, jak si je vyrobit sám: od fyziky, proč tóny vůbec ladí, přes skládání melodií a akordů, sound design a syntézu až po hotový herní soundtrack a cestu, jak se skládat naučit.

Terminologie je z velké části anglická (piano roll, voicing, chord progression), protože přesně tak ji potkáš v DAW i na tutoriálech; klasická hudební teorie zůstává česky, kde má zavedené názvy.

Témata a kapitoly:

**Základy hudební teorie**

- **[Fyzika souzvuku](fyzika-souzvuku.md)** — proč tóny ladí a neladí: zázněj dvou sinusovek, alikvóty a harmonická řada, a proč mají jiné kultury jiné stupnice. Disonance jako řízená páka napětí.
- **[Základy hudební teorie](hudebni-teorie-zaklady.md)** — praktické minimum pro DAW: noty, půltóny a celé tóny, stupnice jako vzorce a stavba triád ze stupnice.
...
- **[Sedm pilířů skladatele](cesta-skladatele.md)** — skládání jako strom dovedností (poslech, harmonie, kontrapunkt, forma, orchestrace, ear training, psaní) a proč „piš, piš, piš" drží zbytek pohromadě.
- **[Začít a vydržet](zacit-a-vydrzet.md)** — syrový devlog o začátcích: hyperfokus a pauzy, hučení melodií do telefonu a „staré skladby zní hrozně = zlepšil ses".
