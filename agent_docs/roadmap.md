...
- [ ] **Batch 15 next (návrh):** Prostředí a environment art — P-ENV (10 videí; breakdowny AAA světů) navazuje na terén/PCG blok. Alternativa: Materiály a VFX + Osvětlení (6+6, menší).
