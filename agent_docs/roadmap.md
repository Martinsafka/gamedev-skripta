...
- [ ] **Batch 14 next (návrh):** PCG část B — pcg-vegetace (12 videí, z toho 1 bez přepisu, 1 skip promo) + případovka Hex-A-Gone. Alternativa: Materiály a VFX + Osvětlení (6+6, menší).
