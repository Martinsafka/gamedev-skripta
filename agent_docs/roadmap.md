...
- [ ] **Batch 19 next (návrh) — FINÁLE Phase 3:** AI nástroje ve vývoji — P-AITOOLS (14 videí, největší zbývající). Po něm zbydou jen odložené kusy (2 lp kurzy, CS video) a Phase 4 (Zápisky).
